...
for item in folder_list:
    data_root = os.path.abspath(os.path.join(os.getcwd(), "../.."))  # get data root path
    image_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "origin")
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_peppersalt", "1", filename)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_peppersalt", "2", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_peppersalt", "3", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_peppersalt", "4", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_peppersalt", "5", filename)
        cv2.imwrite(save_path, out)
#
# #添加高斯噪声1
folder_list = ["glioma", "meningioma", "notumor", "pituitary"]
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_gasuss_noise", "1", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_gasuss_noise", "2", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_gasuss_noise", "3", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_gasuss_noise", "4", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_gasuss_noise", "5", filename)
        cv2.imwrite(save_path, out)
#
# # 添加高斯模糊1
folder_list = ["glioma", "meningioma", "notumor", "pituitary"]
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_gasuss_blur", "1", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_gasuss_blur", "2", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_gasuss_blur", "3", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_gasuss_blur", "4", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_gasuss_blur", "5", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_haze", "1", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_haze", "2", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_haze", "3", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_haze", "4", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "add_haze", "5", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                                  "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "over_exposure", "1", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                          "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "over_exposure", "2", filename)
        cv2.imwrite(save_path, out)
...
for item in folder_list:
    ...
    for filename in os.listdir(image_path):
        ...
        save_path = os.path.join(data_root, "home", "MZ2109123", "deep-learning-for-image-processing-master",
                                      "data_set", "Medical image", "Brain Tumor MRI Dataset", "Training", item, "under_exposure", "1", filename)
        cv2.imwrite(save_path, out)
